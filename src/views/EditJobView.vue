...
const toast = useToast();
    ...
    const handleSubmit = async () => {
      const updatedJobObject = JSON.parse(JSON.stringify(form));

      try {  
            const apiUrl = import.meta.env.VITE_BASE_URL;
            const response = await axios.put(`${apiUrl}/jobs/${route.params.id}`,updatedJobObject);
